		...
		<PortfolioDiv className='portfolio'>
			...
			<ProjectSection>
				<div className='hvr-float'>
					...
					<ul>
						<li>
							ReVitalize is a crowdfunding platform that creates apprenticeship
							opportunities to help tradesmen develop skills to gain licensing through
							projects that help communities.
						</li>
						<li>
							Collaborated with 4 remote team members in an Agile development
							environment to iterate through 3 client approved release-canvasses of
							numerous bug fixes, accessibility issues and addition of several new
							features.
						</li>
						<li>
							...
							<ul>
								<li>
									Constructing the FAQ page to clearly represent the application's intent
									and answer frequently asked questions users might have while also
									integrating styles with the application's existing dark mode.
								</li>
								<li>
									Achieving 100% test coverage for the footer component using Jest.
								</li>
								<li>
									Re-designing the dashboard component to fully responsive across
									desktop, tablet and phone views and dark mode compatible.
								</li>
							</ul>
						</li>
						<li>
							Pair programmed with several other team member to fix the bugs in the
							footer component and fix state management issue in the dashboard
							component.
						</li>
						<a
				...
				<div className='hvr-float'>
					...
					<ul>
						<li>
							An application that shows lists of top movies & tv shows from the IMDB
							API and allows you to search for any movie or show.
						</li>
						<li>
							Created an asynchronous custom React hook that takes in a url and returns
							data, loading & error state, making displaying each returned state easy
							and quick. I have since adopted this hook in my NASA Photo Of The Day
							application as well.
						</li>
						<li>
				...
				<div className='hvr-float'>
					...
					<ul>
						<li>
							An application that displays the "Astronomy Photo Of The Day" from NASA's
							API along with a description.
						</li>
				...
				<div className='hvr-float'>
					...
					<p>
						React | The Reducer Pattern (via useReducer hook) | Styled-Components.
					</p>
					<ul>
						<li>
...
const ProjectSection = styled.div`
	...
	div {
		...
		text-align: center;
		margin: 3%;
		background: rgba(120, 136, 140, 0.5);
		border-radius: 5px;
